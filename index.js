...
_.map = function(collection, fn){
    var arr = [];
    _.each(collection, function(elt, loc, coll){
        arr.push(fn(elt, loc, coll));
    });
    return arr;
};
...
var trueArray = [];
trueArray = _.filter(arr, func);
var falseArray = [];
falseArray = _.reject(arr, func);

var bothArrays = [trueArray, falseArray];
